...
export const dataPotensi: Potensi[] = [
  {
    judul: "Ruang Terbuka Hijau",
    deskripsi: "Pemanfaatan tepi jalan sebagai RTH yang ditanami tanaman hortikultura oleh masyarakat, menjadikan Kelurahan Siparappe mencapai ketahanan pangan mandiri."
  },
  {
    judul: "Perkumpulan Petani Pengguna Air (P3A)",
